  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (result.access_token) {
        ...
        // Reload to reinitialize auth context with new token
      ...
      if (err.status === 401 || err.response?.status === 401) {
        ...
        setError("ليس لديك صلاحية للدخول");
      ...
      >
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="relative">
            ...
            >
              {showPassword ? (
                <EyeOff className="w-5 h-5" style={{ color: "rgba(255,255,255,0.5)" }} />
              ) : (
                <Eye className="w-5 h-5" style={{ color: "rgba(255,255,255,0.5)" }} />
              )}
            </button>
          </div>
          ...
          <motion.button
            ...
            style={{
              background: isLoading
                ...
                : "linear-gradient(135deg, #C8A96B 0%, #A8893B 100%)",
